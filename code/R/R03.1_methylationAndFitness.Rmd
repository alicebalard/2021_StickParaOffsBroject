...
knitr::opts_chunk$set(cache = TRUE, warning = FALSE, 
                      message = FALSE, cache.lazy = FALSE, cache.path = "../../gitignore/RmdCache/")
```
...
# Link between methylation and fitness (BCI)
...
## Question: in our 5 datasets: Is there a correlation between nbr of methylated sites and coverage? YES
