...
- sex explains 2.3% of the observed variance p < 0.01
...
for (i in 1:4){
  ...
  print(ComplexUpset::upset(
    ...
    )) + ggtitle(paste0("Differentially methylated sites found in more than four brother pairs in the comparison: ", vecCompaVerbose[i])))
}
```
