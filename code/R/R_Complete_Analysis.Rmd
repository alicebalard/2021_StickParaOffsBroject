...
## What are the only paternal effect?? [dead end so far, to explore if needed]
Case 1: methylation is dependant of genetic background. Brothers are not clone.
Case 2: methylation in fathers at ANOTHER position affected the methylation of G2!
Test: r=(G1i-G1c)/(mean(G2fromG1i)-mean(G2fromG1c))
r=1 means that Case 1
r close to zero means Case 2
