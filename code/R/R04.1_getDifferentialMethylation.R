...
saveRDS(DMS15pc_G1_half, file = "../../data/DMS15pc_G1_half.RDS")

DMR15pc_G1_half <- getDiffMeth(tiles_G1, fullMetadata_PAR)
saveRDS(DMR15pc_G1_half, file = "../../data/DMR15pc_G1_half.RDS")
