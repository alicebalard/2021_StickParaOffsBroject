...
uniteCov6_G1_woSexAndUnknowChr # methylBase object with 1188179 rows
tiles_G1 = tileMethylCounts(uniteCov6_G1_woSexAndUnknowChr,win.size=100,step.size=100,cov.bases = 10)
tiles_G1 # methylBase object with 26753 rows

uniteCov14_G2_woSexAndUnknowChr_G1CONTROL <- reorganize(methylObj = uniteCov14_G2_woSexAndUnknowChr,
                                                        treatment = fullMetadata_OFFS$trtG1G2_NUM[
                                                          fullMetadata_OFFS$trtG1G2_NUM %in% c(5,6)],
                                                        sample.ids = fullMetadata_OFFS$ID[
                                                          fullMetadata_OFFS$trtG1G2_NUM %in% c(5,6)])
uniteCov14_G2_woSexAndUnknowChr_G1CONTROL # methylBase object with 1050222 rows
tiles_G2_G1CONTROL = tileMethylCounts(uniteCov14_G2_woSexAndUnknowChr_G1CONTROL,win.size=100,step.size=100,cov.bases = 10)
tiles_G2_G1CONTROL # methylBase object with 21029 rows

uniteCov14_G2_woSexAndUnknowChr_G1INFECTED <- reorganize(methylObj = uniteCov14_G2_woSexAndUnknowChr,
                                                         treatment = fullMetadata_OFFS$trtG1G2_NUM[
                                                           fullMetadata_OFFS$trtG1G2_NUM %in% c(2,3)],
                                                         sample.ids = fullMetadata_OFFS$ID[
                                                           fullMetadata_OFFS$trtG1G2_NUM %in% c(2,3)])
uniteCov14_G2_woSexAndUnknowChr_G1INFECTED # methylBase object with 1050222 rows
tiles_G2_G1INFECTED = tileMethylCounts(uniteCov14_G2_woSexAndUnknowChr_G1INFECTED,win.size=100,step.size=100,cov.bases = 10)
tiles_G2_G1INFECTED # methylBase object with 21029 rows
...
## DMS15pc_PAR_half <- getDiffMeth(uniteCov6_G1_woSexAndUnknowChr, fullMetadata_PAR)
...
## for f in DMR15pc*; do mv "$f" "$(echo "$f" | sed s/.RDS/_23feb22.RDS/)"; done
