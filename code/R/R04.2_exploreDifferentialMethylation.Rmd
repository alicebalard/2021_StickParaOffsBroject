...
## Genes with at least 10 CpG differentially methylated:
genes10DMS <- anot4BP[anot4BP$nCpG >= 10,]
```


```{r, echo=FALSE, results='asis'}
kable(data.frame(chr=genes10DMS$chr, gene=unlist(genes10DMS$Note), row.names = NULL))
```
